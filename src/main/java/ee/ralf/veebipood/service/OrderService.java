package ee.ralf.veebipood.service;

import ee.ralf.veebipood.dto.EveryPayBody;
import ee.ralf.veebipood.dto.EveryPayResponse;
import ee.ralf.veebipood.dto.OrderRowDto;
import ee.ralf.veebipood.dto.PaymentUrl;
...
public class OrderService {
    ...
    public PaymentUrl makePayment(Long orderId, double sum) {
        ...
        body.setOrder_reference("ralf" + orderId); // kui on makstud, siis teist korda maksma minna ei saa
